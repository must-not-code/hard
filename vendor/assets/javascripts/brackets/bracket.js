    ...
    var JqueryBracket = function (opts) {
        ...
        function mkMatch(round, data, idx, results, renderCb) {
            ...
            function teamElement(round, team, isReady) {
                ...
                var nEl = $('<div class="player"></div>').appendTo(tEl);
                    ...
                    nEl.click(function () {
                        ...
                        function editor() {
                            function done_fn(val, next) {
                                ...
                                renderAll(true);
                                span.click(editor);
                                var labels = opts.el.find('.team[data-teamid=' + (team.idx + 1) + '] div.player:first');
        ...
        if (opts.save)
            topCon.css('width', rounds * 160 + 40);
        else
            topCon.css('width', rounds * 160 + 10);
